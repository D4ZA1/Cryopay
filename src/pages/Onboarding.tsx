...
const OnboardingScreen = () => {
  ...
  const selfCustody = { icon: <KeyRound size={28} />, title: "Self-Custody Wallet", tagline: "For experts. You control your own keys.", label: "Non-Custodial", description: "You are in complete control. Your wallet is auto-generated at signup and encrypted with your password. Your private key never leaves your device unencrypted.", advantages: ["You have 100% control of your funds", "Maximum decentralization and privacy"], disadvantages: ["Lose your keys, lose your funds forever", "You are responsible for gas fees"], buttonText: "Create Wallet", to: "/signup-non-custodial" };
