    ...
    >
      <nav className="nav-inner">
        ...
        <div className="nav-links">
          {['How It Works', 'Features', 'Impact', 'For Cities'].map((item) => (
        ...
        <div className="nav-actions">
          ...
          <motion.button className="btn-primary" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} onClick={() => navigate('/connect-wallet')}>
            Get Started
          </motion.button>
        </div>
      </nav>
